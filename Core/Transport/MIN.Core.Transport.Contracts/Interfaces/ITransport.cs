...
public interface ITransport
{
    ...
    /// </summary>
    Task<Guid> StartHostingAsync(Guid? serverConnectionId = null, ushort? prefferedPort = null, int? sequentialAttempts = null, CancellationToken cancellationToken = default);
